...
public class ProductToXmlListTest
{
  ...
  public void setUp()
  {
    ...
    product = new Product("PO1", "Spring Guru Mug",
            "https://springframework.guru/wp-content/uploads/2017/12/spring_framework_guru_mug-rf412049699c14ba5b68bb1c09182bfa2_8nax2_512.jpg",
            new BigDecimal(18.95), user);
    product1 = new Product("PO2", "Spring Guru Shirt",
  ...
  public void testObjectToXml() throws JAXBException
  {
    ...
    marshaller.marshal(products, new File("src/test/resources/test-jaxb/products.xml"));
